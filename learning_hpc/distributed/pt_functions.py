"""
This file contains autograd functions for distributed operations, directly copy-pasted 
from PyTorch at this link: https://github.com/pytorch/pytorch/blob/main/torch/distributed/nn/functional.py.

These functions are put here rather than imported to guard against potential changes in the  
PyTorch distributed library. Custom functions are in the 'functions.py' file.
"""
